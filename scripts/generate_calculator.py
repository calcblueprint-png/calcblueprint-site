...
6. Include 3 long-form content sections below the calculator: "How to Calculate [X]", "What Affects [X]", and "Frequently Asked Questions" with 3 Q&As each. Each section should be 100-200 words with real construction industry detail. CRITICAL: For the FAQ section, use this exact structure for each Q&A: <h3>Question text</h3><p>Answer text</p>. Each question and answer MUST be on separate tags. Do NOT put multiple Q&As inside a single <p> tag. Do NOT use "Q:" and "A:" prefixes. Do NOT use <strong> for questions. Every content section must be wrapped in <section class="content-section"> and the CSS must include: .content-section { background-color: #ffffff; border-radius: 8px; padding: 2rem; margin-bottom: 2rem; }. Do NOT create content sections without a white card background.
